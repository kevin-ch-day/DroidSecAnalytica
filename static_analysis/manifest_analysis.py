...
from . import intent_filters_analysis
...
def heuristic_analysis(manifest_data: Dict) -> Dict:
    ...
    overprivileged_results = save_detected_permissions.identify_overprivileged_apps(manifest_data)
    analysis_results.update(overprivileged_results)

    # Heuristic 2: Check for Uncommon or Sensitive Permissions
    analysis_results['sensitive_permissions'] = save_detected_permissions.check_sensitive_permissions(manifest_data)
    ...
    analysis_results['network_related_permissions'] = save_detected_permissions.check_network_permissions(manifest_data)
