...
from database import DBFunct_Other
...
def analyze_intent_filters(manifest_data: Dict) -> List[str]:
    ...
    unusual_intents = DBFunct_Other.get_intent_filters(is_unusual=True)
    common_intents = DBFunct_Other.get_intent_filters(is_unusual=False)
